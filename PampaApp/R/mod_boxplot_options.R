...
mod_boxplot_options_server <- function(id){
  moduleServer( id, function(input, output, session){
    ...
    shiny::observeEvent(input$boxplot_options_ok, {
      setOption("P.maxExclu", input$boxplot_options_max_exclu)
      setOption("P.GraphPartMax", input$boxplot_options_prop_max)
      setOption("P.NbObs", input$boxplot_options_nb_obs)
      setOption("P.NbObsCol", input$boxplot_options_nb_obs_col)
      setOption("P.warnings", input$boxplot_options_warnings)
      setOption("P.sepGroupes", input$boxplot_options_group_sep)
      setOption("P.sepGroupesCol", input$boxplot_options_group_sep_col)
      setOption("P.legendeCouleurs", input$boxplot_options_colour_legend)
      setOption("P.pointMoyenne", input$boxplot_options_mean_pts)
      setOption("P.pointMoyenneCol", input$boxplot_options_mean_pts_col)
      setOption("P.pointMoyenneCex", input$boxplot_options_mean_pts_cex)
      setOption("P.pointMoyennePch", input$boxplot_options_mean_pts_type)
      setOption("P.valMoyenne", input$boxplot_options_mean_val)
      setOption("P.valMoyenneCol", input$boxplot_options_mean_val_col)
      setOption("P.NbDecimal", input$boxplot_options_nb_decimal)

      shiny::removeModal()
    })

    shiny::observeEvent(input$boxplot_options_reset, {
      setOption("P.maxExclu", boxplot_optn$max_exclu)
      setOption("P.GraphPartMax", boxplot_optn$prop_max)
      setOption("P.NbObs", boxplot_optn$nb_obs)
      setOption("P.NbObsCol", boxplot_optn$nb_obs_col)
      setOption("P.warnings", boxplot_optn$warnings)
      setOption("P.sepGroupes", boxplot_optn$group_sep)
      setOption("P.sepGroupesCol", boxplot_optn$group_sep_col)
      setOption("P.legendeCouleurs", boxplot_optn$colour_legend)
      setOption("P.pointMoyenne", boxplot_optn$mean_pts)
      setOption("P.pointMoyenneCol", boxplot_optn$mean_pts_col)
      setOption("P.pointMoyenneCex", boxplot_optn$mean_pts_cex)
      setOption("P.pointMoyennePch", boxplot_optn$mean_pts_type)
      setOption("P.valMoyenne", boxplot_optn$mean_val)
      setOption("P.valMoyenneCol", boxplot_optn$mean_val_col)
      setOption("P.NbDecimal", boxplot_optn$nb_decimal)
